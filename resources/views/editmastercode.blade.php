    ...
    <div id="maincontainer" class="clearfix">
        ...
        <div id="contentwrapper">
            <div class="main_content">
                ...
                <h3 class="heading" style="color: rgb(26, 239, 54)">Edit master code record</h3>
                ...
                <form action="{{ route('update-md-code')}}" method="POST"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-md-3">
                            ...
                            <input class="form-control" type="text" name="mc_code" value="{{$item->mc_code}}" id="mc_code">            
                        </div>

                        <div class="col-sm-3 col-md-3">
                            <label for="mask_product">Master code name</label>
                            <input class="form-control" type="text" name="mc_name" value="{{$item->mc_name}}" id="mc_name">
                           
                        </div>

                        <div class="col-sm-3 col-md-3 ">
                            <label for="">Master description</label>
                            <textarea class="form-control" name="mc_description" value={{$item->mc_description}} id="mc_description"></textarea>
                       </div>
                       ...
                       @endforeach
                        ...
                        <br> 
                        <div class="col-sm-3 col-md-3">
                           <button class="btn btn-primary" id="add_code_data" >submit</button>
                        </div>
    ...
    <script type="text/javascript">
        // Jquery entering here
            ...
            $(document).ready(function(){
					$('#add_code_data').click(function(){


                    var mc_id = $('#mc_id').val();
                    var mc_code = $('#mc_code').val();
                    var mc_name = $('#mc_name').val();
                    var mc_description = $('#mc_description').val();
                    var user_id = $('#user_id').val();

                    var form_data = new FormData();

                    form_data.append('mc_id', mc_id);
                    form_data.append('mc_code', mc_code);
                    form_data.append('mc_name', mc_name);
                    form_data.append('mc_description', mc_description);
