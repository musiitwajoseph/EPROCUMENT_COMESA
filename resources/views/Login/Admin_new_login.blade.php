        ...
        <div id="contentwrapper">
            <div class="main_content">
                <div id="jCrumbs" class="breadCrumb module">
                    <h1 style="text-align: center;color:blue;">COMESA USER REGISTRATION</h1>
                </div>
                    ...
                    <fieldset title="Contract info">
							...
							<div class="formSep form-group">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="firstname" id="firstname" class="input-sm form-control" placeholder="Enter Firstname" value="{{old('username')}}" required>
                                    <span class="text-danger">@error('firstname'){{$message}}@enderror</span>
                                </div>
    
                                <div class="mb-3 col-md-6">
                                    <label>Lastname<span class="text-danger">*</span></label>
                                    <input type="text" name="lastname" id="lastname" class="input-sm form-control" placeholder="Enter Lastname" value="{{old('username')}}" required>
                            ...
                            <div class="mb-3  col-md-6" style="margin-top: 1rem;">
                                ...
                                <input type="text" name="username" id="username" class="input-sm form-control" placeholder="Enter username" value="{{old('username')}}" required>
                            ...
                            <div class="mb-3 col-md-6" style="margin-top: 1rem;">
                                ...
                                <input type="text" name="phonenumber" id="phonenumber" class="input-sm form-control" placeholder="Enter phonenumber" value="{{old('username')}}" required>
                                <span class="text-danger">@error('phonenumber'){{$message}}@enderror</span>
                            </div>

                            <div class="mb-3 col-md-6" style="margin-top: 1rem;">
                                <label>Email<span class="text-danger">*</span></label>
                                <input type="email" name="email" id="email" class="input-sm form-control" placeholder="Enter Email" value="{{old('email')}}" required>
