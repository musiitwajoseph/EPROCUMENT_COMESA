...
<html lang="en" class="login_page">
    ...
    <body>
        ...
        <div class="login_box">
            ...
            <form action="{{ route('auth.save') }}" method="post" id="login_form">

                @csrf
                <div class="top_b">Sign up to COMESA Supplier Portal</div>    
                ...
                <div class="cnt_b">
                    <div class="formRow">
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-user"></i></span><input type="email" id="email" name="email" placeholder="email"  value="{{ old('email')}}" />
                    ...
                    <div class="formRow">
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-lock"></i></span><input type="password" id="password" name="password" placeholder="Password"  value="{{ old('password')}}" />
                ...
                <div class="btm_b clearfix">
                    <button class="btn btn-inverse pull-right" type="submit" id="supplier_sign_in">Sign In</button>
            ...
            <form action="{{ route('auth.check') }}" method="post" id="reg_form" style="display:none">
                @csrf
                <div class="top_b">Login to COMESA Supplier Portal</div>    
          ...
          @endif
                ...
                <div class="btm_b clearfix">
                    <button class="btn btn-inverse pull-right" type="submit" id="supplier_login_in">Sign In</button>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('#login_form').validate({
                    ...
                    validClass: 'valid',
                    rules: {
                        email: { required: true, minlength: 3 , email},
