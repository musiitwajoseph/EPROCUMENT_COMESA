        ...
        <div id="contentwrapper">
            <div class="main_content">
                ...
                <div class="row">
                    ...
                    <div class="row" id="dashboard_menu">
                        <div class="col-sm-12 tac">
                            ...
                            <h1 style="text-align: center;color:#fff;margin:3rem;background-color:blue;">Recommended
                                for Cancellation </h1>

								<input type="hidden" name="user_admin_id" id="user_admin_id"
								value={{ $LoggedUserAdmin['id'] }}>
								
                            {{-- <a href="" class="btn btn-danger pull-right">Cancel All Applications</a> --}}
                            <table class="table table-bordered table-striped" id="smpl_tbl">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="text-align: left">
                                        @foreach ($saved_documents as $doc)
                                            ...
                                            <a
                                                href="{{ url('download/' . $doc->Attachments) }}">{{ $doc->Attachments }}</a><br />
                                        @endforeach
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <h3>5.Reason for rejecting this Supplier Application</h3>
                                    </td>
                                </tr>

                                <tr>
                                    <td colspan="4" style="text-align: left;margin-top:2rem;">
                                        {{ $info->reason_for_rejection }}</td>
                                </tr>
                ...
                <div style="padding-top: 1rem;">
                    ...
                    <p style="text-align: left;font-weight:bold;">Approval Officer Email: {{ $info->approved_email }}
                    </p>
