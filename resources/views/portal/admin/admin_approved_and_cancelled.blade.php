        ...
        <div id="contentwrapper">
            <div class="main_content">
                ...
                <div class="row">
                    ...
                    <div class="row" id="dashboard_menu">
                        <div class="col-sm-12 tac">
                            ...
                            <h1 style="text-align: center;color:#FFF;margin:3rem;background-color:blue;">Recommended to
                                be Apprroved</h1>
                            <table class="table table-bordered table-striped" id="smpl_tbl">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <h3>5.Reason for Accepting Application</h3>
                                    </td>
                                </tr>
                ...
                <div style="padding-top: 1rem">
                    ...
                    <p style="text-align: left;font-weight:bold;">Procurement Officer Email :
                        {{ $info->approved_email }}</p>
