    ...
    <div id="maincontainer" class="clearfix">
        ...
        <div id="contentwrapper">
            <div class="main_content">
                ...
                <h3 class="heading" style="color: rgb(26, 239, 54)">Edit supplier document</h3>
                ...
                <form action="{{ route('edit-supplier-document')}}" method="POST"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-md-3">
                            ...
                            <input class="form-control" type="text" name="supplier_document" id="supplier_document" value="{{$item->md_name}}" required>
                            @endforeach
                        </div>
