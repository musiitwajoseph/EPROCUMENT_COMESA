                ...
                <form id="validate_wizard" class="stepy-wizzard form-horizontal">
                    ...
                    <fieldset title="Contact info">
						...
						<div class="formSep form-group">
							...
							<input type="hidden" value="<?php echo $counter-1; ?>" id="totalDocuments"/>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Certificate of Registration/Incorporation :</label>
								<input type="text" name="certificate_of_Registration_Incorporation" id="certificate_of_Registration_Incorporation" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file"  name="certificate_of_Registration_Incorporation_Attach" id="certificate_of_Registration_Incorporation_Attach" class="input-sm form-control " required>
							</div>


							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Revenue Authority TPIN Certificate :</label>
								<input type="text" name="Revenue_Authority_TPIN_Certificate" id="Revenue_Authority_TPIN_Certificate" class="input-sm form-control" required>
							</div>	
							
							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="Revenue_Authority_TPIN_Certificate_Attach" id="Revenue_Authority_TPIN_Certificate_Attach" class="input-sm form-control " required>
							</div>

							
							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Tax Compliance Certificate : </label>
								<input type="text" name="Tax_Compliance_certificate" id="Tax_Compliance_certificate" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="Tax_Compliance_certificate_Attach" id="Tax_Compliance_certificate_Attach" class="input-sm form-control " required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Article of Association | CR12 document :</label>
								<input type="text" name="Article_of_Association" id="Article_of_Association" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="Article_of_Association_Attach" id="Article_of_Association_Attach" class="input-sm form-control " required>
							</div>


							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Company profile :</label>
								<input type="text" name="Company_profile" id="Company_profile" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="Company_profile_Attach" id="Company_profile_Attach" class="input-sm form-control " required>
							</div>
							
							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Bank Reference Letter : </label>
								<input type="text" name="Bank_Refrence_letter" id="Bank_Refrence_letter" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="Bank_Refrence_letter_Attach" id="Bank_Refrence_letter_Attach" class="input-sm form-control " required>
							</div>


							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Audited financial reports :</label>
								<input type="text" name="Audited_financial_reports" id="Audited_financial_reports" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="Audited_financial_reports_Attach" id="Audited_financial_reports_Attach" class="input-sm form-control " required>
							</div>
							...
							<div class="col-md-6">
								...
								<input type="text" name="Recommendation_letters_from_current_clients" id="Recommendation_letters_from_current_clients" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="Recommendation_letters_from_current_clients_Attach" id="Recommendation_letters_from_current_clients_Attach" class="input-sm form-control " required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">LPO’s or Contracts offering similar services :</label>
								<input type="text" name="LPOs_offering_similar_services" id="LPOs_offering_similar_services" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="LPOs_offering_similar_services_Attach" id="LPOs_offering_similar_services_Attach" class="input-sm form-control " required>
							</div>	
							
							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">A balance sheet account  :</label>
								<input type="text" name="A_balance_sheet_account" id="LPOs_offering_similar_services" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="A_balance_sheet_account_Attach" id="A_balance_sheet_account_Attach" class="input-sm form-control " required>
							</div>	


							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Labour office Registration No :</label>
								<input type="text" name="Labour_office_Registration_No" id="Labour_office_Registration_No" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="Labour_office_Registration_No_Attach" id="Labour_office_Registration_No_Attach" class="input-sm form-control " required>
							</div>	


							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Labour Office Compliance Status certificate :</label>
								<input type="text" name="Labour_Office_Compliance_Status_certificate" id="Labour_Office_Compliance_Status_certificate" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="Labour_Office_Compliance_Status_certificate_Attach" id="Labour_Office_Compliance_Status_certificate_Attach" class="input-sm form-control " required>
							</div>	


							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Certificate of completion|delivery :</label>
								<input type="text" name="Certificate_of_completion_delivery" id="Certificate_of_completion_delivery" class="input-sm form-control" required>
							</div>

							<div class="col-md-6">
								<label for="" class="boldTitle padMarg" class="padMarg">Attach :</label>
								<input type="file" name="Certificate_of_completion_delivery_Attach" id="Certificate_of_completion_delivery_Attach" class="input-sm form-control " required>
							</div>	
				...
				<script type="text/javascript">
					...
					$(document).ready(function(){
						$('#Supplier_Registration_Details').click(function(){
							...
							// Accesssing Attachments Header Names 

							var certificate_of_Registration_Incorporation = $('#certificate_of_Registration_Incorporation').val();
							var Revenue_Authority_TPIN_Certificate = $('#Revenue_Authority_TPIN_Certificate').val();
							...
							var A_balance_sheet_account = $('#A_balance_sheet_account').val();
							var Labour_office_Registration_No = $('#Labour_office_Registration_No').val();
							var Labour_Office_Compliance_Status_certificate = $('#Labour_Office_Compliance_Status_certificate').val();
							var Certificate_of_completion_delivery = $('#Certificate_of_completion_delivery').val();
							...
							var Revenue_Authority_TPIN_Certificate_Attach = $('#Revenue_Authority_TPIN_Certificate_Attach').prop('files')[0];
							...
							var Company_profile_Attach = $('#Company_profile_Attach').prop('files')[0];
							...
							var A_balance_sheet_account_Attach = $('#A_balance_sheet_account_Attach').prop('files')[0];
							var Labour_office_Registration_No_Attach = $('#Labour_office_Registration_No_Attach').prop('files')[0];
							var Labour_Office_Compliance_Status_certificate_Attach = $('#Labour_Office_Compliance_Status_certificate_Attach').prop('files')[0];
							var Certificate_of_completion_delivery_Attach = $('#Certificate_of_completion_delivery_Attach').prop('files')[0];


							//Passing Data to the Controller Form
							var form_data = new FormData();
							...
							// Appending Attachment Headers Names

							form_data.append('certificate_of_Registration_Incorporation', certificate_of_Registration_Incorporation);
							form_data.append('Revenue_Authority_TPIN_Certificate', Revenue_Authority_TPIN_Certificate);
							...
							form_data.append('Company_profile', Company_profile);
							...
							form_data.append('A_balance_sheet_account', A_balance_sheet_account);
							form_data.append('Labour_office_Registration_No', Labour_office_Registration_No);
							form_data.append('Labour_Office_Compliance_Status_certificate', Labour_Office_Compliance_Status_certificate);
							form_data.append('Certificate_of_completion_delivery', Certificate_of_completion_delivery);

							// Appending Attachment Documents

							form_data.append('certificate_of_Registration_Incorporation_Attach', certificate_of_Registration_Incorporation_Attach);
							form_data.append('Revenue_Authority_TPIN_Certificate_Attach', Revenue_Authority_TPIN_Certificate_Attach);
							...
							form_data.append('Company_profile_Attach', Company_profile_Attach);
							...
							form_data.append('A_balance_sheet_account_Attach', A_balance_sheet_account_Attach);
							form_data.append('Labour_office_Registration_No_Attach', Labour_office_Registration_No_Attach);
							form_data.append('Labour_Office_Compliance_Status_certificate_Attach', Labour_Office_Compliance_Status_certificate_Attach);
							form_data.append('Certificate_of_completion_delivery_Attach', Certificate_of_completion_delivery_Attach);
