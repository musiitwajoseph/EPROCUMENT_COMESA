                            ...
                            <div class="row">
                                <div class="row">
                                    <div class="col-sm-12 col-md-12">
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td class="table_checkbox"
                                                            style="text-align: center;font-weight:bold;">Amount for purchase
                                                        </td>
                                                    ...
                                                    @foreach ($values as $key => $value)
                                                        <tr>
                                                            ...
                                                            <td class="table_checkbox" style="text-align: center;">
                                                                {{ $value->qty }}</td>
                                                            <td class="table_checkbox" style="text-align: center;">
                                                                {{ $value->amount_needed }}</td>
                                                            <td class="table_checkbox" style="text-align: center;">
                                                                {{ $value->reason_for_purchase }}</td>

                                                            <td class="table_checkbox"
                                                                style="text-align: center;width:1px;"><a
                                                                href="{{ url('approve-requistion-not-planned-asg-finance/'.$value->id)}}"
                                                                    class="btn btn-primary">Approve</a>
                                                            </td>

                                                            <td style="text-align: center;width:1px;"><a
                                                                    href="{{ url('reject-requistion-not-planned-asg-finance/'.$value->id)}}"
                                                                    class="btn btn-small btn-danger">Reject</a></td>
                                        ...
                                        {{-- <input type="hidden" id="approve_hidden_id" value="{{$value->id}}"> --}}
                                        ...
                                        {{-- 
                                        <div class="col-sm-4 col-md-4" id="reason_section">
                                            <h3>Approvers</h3>
                                            <br>
                                            <textarea id="reason" class="form-control" id="" cols="30" rows="10"></textarea>
                                        </div>
