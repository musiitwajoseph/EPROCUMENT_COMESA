...
<head>
    ...
    <title>Procurement Assign Officer </title>
    ...
    <div id="maincontainer" class="clearfix">
        ...
        <div id="contentwrapper">
            <div class="main_content">
                ...
                <h3 class="heading" style="color: rgb(26, 30, 239)">Assign / Re-allocate  requisition to Procurement officer for processing.</h3>
                ...
                <form action="{{ route('assign-procurement-officer') }}" method="POST"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-md-3">
                            <label >Role</label>
                            <h3 style="border: 2px solid blue;padding:0.36rem;text-align:center;">{{$item->user_role}}</h3>
                        </div>
