            ...
            <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand pull-left" href="{{ route('post-excel-sheet') }}">COMESA :: EPROCUREMENT</a>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <h3 class="heading">Upload Excel</h3>
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <form action="{{route('post-excel-sheet')}}" method="POST" class="stepy-wizzard form-horizontal" enctype="multipart/form-data" >
                                        ...
                                        @csrf
                                            ...
                                            <div class="formSep form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    style="">Choose excel file to upload:</label>
                                                    <input type="file" name="file1" class="input-sm form-control" required>
                                                </div>

                                                 <div class="col-md-3">
                                                    <label  control-labelq"
                                                    style="">Enter name of sheet:</label>
                                                  
                                                    <input type="text" name="name_sheet" placeholder="Enter Sheet Name" class="input-sm form-control" required>
                                                </div>
