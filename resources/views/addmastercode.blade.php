    ...
    <div id="maincontainer" class="clearfix">
        ...
        <div id="contentwrapper">
            <div class="main_content">
                ...
                <h3 class="heading" style="color: rgb(26, 239, 54)">Add master code</h3>
                ...
                <form action="{{ route('send-master-code')}}" method="POST"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-md-3">
                            ...
                            <input class="form-control" type="text" name="mc_code" id="mc_code" required>            
                        </div>

                        <div class="col-sm-3 col-md-3">
                            <label for="mask_product">Master code name</label>
                            <input class="form-control" type="text" required name="mc_name" id="mc_name">
