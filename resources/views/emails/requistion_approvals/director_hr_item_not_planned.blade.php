...
<body>    
    ...
    <p> I trust this message finds you well. I am writing to you Informing you that the below rasied requistion which wasn't planned on the procurement requesting for your review on it.</p>
    ...
    <ol>
        ...
        <li>Status : Submitted for Approval by Originator </li>
    </ol>
