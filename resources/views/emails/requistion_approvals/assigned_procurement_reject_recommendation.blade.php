...
<body>    
    ...
    <p> I trust this message finds you well. I am writing to you recommending for approving the following requistion after carefully analysis.</p>
    ...
    <p> <span style="font-weight: bold">Reason for recommending this requistion to be rejected :</span></p>
