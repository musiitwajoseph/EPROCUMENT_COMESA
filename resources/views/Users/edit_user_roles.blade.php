...
<body class="full_width">
    ...
    <div id="maincontainer" class="clearfix">
        ...
        <div id="contentwrapper">
            <div class="main_content">
                ...
                <h3 class="heading text-primary" >Edit User Role</h3>
                ...
                <form action="{{ route('edit-user-role-record') }}" method="POST"> 
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" id="user_role_id" name="user_role_id" value="{{$information->id}}">
                        <input type="hidden" id="user_added_by" name="user_added_by" value="{{$information->ur_added_by}}">
                        ...
                        <div class="col-sm-3 col-md-3">
                           <button class="btn btn-primary" id="edit_user_role" >Edit</button>
                        </div>
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function(){
                    ...
                    var user_added_by = $('#user_added_by').val();
                    ...
                    form_data.append('user_added_by', user_added_by);
