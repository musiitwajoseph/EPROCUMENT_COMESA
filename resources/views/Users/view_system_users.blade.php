                ...
                <div class="row">
                    ...
                    @endif
                        ...
                        <section id="Approved_suppliers">
                            <h3 class="heading" style="color: rgb(22, 59, 225)">All user Information</h3>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($info as $item)
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><a  href="{{'edit-system-user/'.$item->id}}" class="btn btn-primary">Edit</a></td>
                                            <td style="text-align: center;"><a onclick="return confirm('Are you sure you want to delete this user from system ?')" href="{{'delete-system-user/'.$item->id}}" class="btn btn-danger">Delete</a></td>
