...
<head>
    ...
    <title>Add a new user right </title>
    ...
    <div id="maincontainer" class="clearfix">
        ...
        <div id="contentwrapper">
            <div class="main_content">
                ...
                <h3 class="heading" style="color: rgb(26, 239, 54)">Add a new user right</h3>
                ...
                <form action="{{ route('store-user-right')}}" method="POST"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-md-3">
                            <label for="mask_product"> Add user right</label>
                            <input class="form-control" type="text" name="user_right" id="user_right" required>
