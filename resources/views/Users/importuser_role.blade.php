...
<body class="full_width">
    ...
    <div id="maincontainer" class="clearfix">
        ...
        <div id="contentwrapper">
            <div class="main_content">
                ...
                <h3 class="heading text-primary" >Import User Role</h3>
                ...
                <form action="{{ route('import-user-role') }}" method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-md-3">
                            <label for="">Import new user role file :</label>
                        ...
                        <div class="col-sm-3 col-md-3">
                           <button class="btn btn-primary" id="import_user_role" >Upload</button>
                        </div>
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function(){
					...
					$('#import_user_role').click(function(){

                    var user_id = $('#user_id').val();
                    var uploadFiles = $('#file1').files;

                    var form_data = new FormData();

                    form_data.append('user_id', user_id);
                    form_data.append('uploadFiles', uploadFiles[0]);
