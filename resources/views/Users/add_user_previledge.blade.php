...
<head>
    ...
    <title>Add a user previledge </title>
    ...
    <div id="maincontainer" class="clearfix">
        ...
        <div id="contentwrapper">
            <div class="main_content">
                ...
                <h3 class="heading" style="color: rgb(26, 239, 54)">Add a new user previledge</h3>
                ...
                <form action="{{ route('store-user-previledges')}}" method="POST"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-md-3">
                            <label for="">User right and  previledge</label>
                            <select name="user_rights" id="user_rights" class="form-control">
                                @foreach ($user_rights as $item)
                                <option value="{{$item->user_right}}">{{$item->user_right}}</option>
                                @endforeach
                               </select>
                        </div>
                        ...
                        <br> 
                        <div class="col-sm-3 col-md-3">
                           <button type="submit" class="btn btn-primary" id="add_new_data" >submit</button>
                        </div>
