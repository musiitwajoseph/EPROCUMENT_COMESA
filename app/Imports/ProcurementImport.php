        ...
        public function isEmptyWhen(array $row): bool
        {
            ...
            public function model(array $row)
            {
                ...
                return new Procurement_plan([
                    'crt_no' => $row[0],
                    'description_of_goods_works_and_services' => $row[2],
            ...
            public function rules(): array
            {
                ...
                // class ProcurementImport implements ToCollection
                // {
                ...
                //         foreach ($rows as $row) 
                //         {
                //             Procurement_plan::updateOrCreate([
                //                 'crt_no' => $row[0],
                //                 'description_of_goods_works_and_services' => $row[2],
                //                 'category_of_procurement' => $row[2],
                //                 'qty' => $row[3],
            ...
            // class ProcurementImport implements OnEachRow
            // {
