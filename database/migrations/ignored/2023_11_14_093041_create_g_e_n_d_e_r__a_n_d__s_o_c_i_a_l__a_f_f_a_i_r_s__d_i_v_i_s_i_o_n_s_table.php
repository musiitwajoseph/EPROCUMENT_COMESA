...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('g_e_n_d_e_r__a_n_d__s_o_c_i_a_l__a_f_f_a_i_r_s__d_i_v_i_s_i_o_n_s', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('g_e_n_d_e_r__a_n_d__s_o_c_i_a_l__a_f_f_a_i_r_s__d_i_v_i_s_i_o_n_s');
    }
};
